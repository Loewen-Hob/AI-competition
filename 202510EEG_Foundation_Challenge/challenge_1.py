...
from braindecode.models import EEGNeX, EEGInceptionERP, EEGConformer
...
DATA_DIR = '/ssd1/zhanghongbo04/002/project/AI-competition/202510EEG_Foundation_Challenge/startkit/data'
...
model = EEGConformer(
    n_chans=129,      # 129 channels
    n_outputs=1,      # 1 output for regression
    n_times=200, # Use the detected n_times (should be 200)
    sfreq=100,        # Sample frequency 100 Hz (Used for positional encoding)
)
print(model)
model.to(device)
